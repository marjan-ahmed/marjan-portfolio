                ...
                <TabsContent value="html">
                  <div className="w-full md:w-5/6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                      ...
                      >
                        ...
                        <div className="p-4 sm:p-6">
                          <div className="flex justify-between items-start mb-4">
                            <h3 className="text-xl font-medium">Clima Website</h3>
                            <Link
                          ...
                          <div className="flex flex-wrap gap-2">
                            <span className="text-xs bg-gray-800 text-gray-300 px-2 py-1 rounded-full">HTML</span>
                            <span className="text-xs bg-gray-800 text-gray-300 px-2 py-1 rounded-full">CSS</span>
                            <span className="text-xs bg-gray-800 text-gray-300 px-2 py-1 rounded-full">JS</span>
                          </div>
                        </div>
                      </div>
                      ...
                      >
                        <div className="relative h-48 bg-gray-900">
                          <Image src="/asphaltlegends.vercel.app_.png" alt="Asphalt Lengends Clone" fill className="object-cover opacity-80" />
                        </div>
                        <div className="p-4 sm:p-6">
                          <div className="flex justify-between items-start mb-4">
                            <h3 className="text-xl font-medium">Asphalt Lengends - Webpage Clone</h3>
                            <Link
                      ...
                      >
                        <div className="relative h-48 bg-gray-900">
                          <Image src="/joke-engine.vercel.app_.png" alt="Joke Generator" fill className="object-cover opacity-80" />
                        </div>
                        <div className="p-4 sm:p-6">
                          <div className="flex justify-between items-start mb-4">
                          ...
                          <div className="flex flex-wrap gap-2">
                            ...
                            <span className="text-xs bg-gray-800 text-gray-300 px-2 py-1 rounded-full">CSS</span>
                            <span className="text-xs bg-gray-800 text-gray-300 px-2 py-1 rounded-full">JS</span>
                            <span className="text-xs bg-gray-800 text-gray-300 px-2 py-1 rounded-full">Random Dad Joke API</span>
                          </div>
                        </div>
                      </div>
                      ...
                      >
                        <div className="relative h-48 bg-gray-900">
                          <Image src="/dynamic-resume-builder-six-lake.vercel.app_.png" alt="Resume Builder" fill className="object-cover opacity-80" />
                        </div>
                        <div className="p-4 sm:p-6">
                          <div className="flex justify-between items-start mb-4">
                            <h3 className="text-xl font-medium">Dynamic Resume Builder</h3>
                            <Link
                  ...
                  <div className="w-full md:w-5/6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                      ...
                      >
                        ...
                        <div className="p-4 sm:p-6">
                          ...
                          <div className="flex flex-wrap gap-2">
                            ...
                            <span className="text-xs bg-gray-800 text-gray-300 px-2 py-1 rounded-full">ShipEngine</span>
                      ...
                      >
                        ...
                        <div className="p-4 sm:p-6">
                          <div className="flex justify-between items-start mb-4">
                            <h3 className="text-xl font-medium">Governor Sindh - Website Clone</h3>
                            <Link
                  ...
                  <div className="w-full md:w-5/6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                      ...
                      >
                        ...
                        <div className="p-4 sm:p-6">
                          <div className="flex justify-between items-start mb-4">
                            <h3 className="text-xl font-medium">Unit Converter</h3>
                            <Link
                          ...
                          <div className="flex flex-wrap gap-2">
                            <span className="text-xs bg-gray-800 text-gray-300 px-2 py-1 rounded-full">Streanlit</span>
                            <span className="text-xs bg-gray-800 text-gray-300 px-2 py-1 rounded-full">UV</span>
                          </div>
                        </div>
                      </div>
                      ...
                      >
                        ...
                        <div className="p-4 sm:p-6">
                          <div className="flex justify-between items-start mb-4">
                            <h3 className="text-xl font-medium">Password Strength Meter</h3>
                            <Link
                      ...
                      >
                        ...
                        <div className="p-4 sm:p-6">
                          <div className="flex justify-between items-start mb-4">
                            <h3 className="text-xl font-medium">BMI (Body Mass Index) Calculator</h3>
                            <Link
                      ...
                      >
                        ...
                        <div className="p-4 sm:p-6">
                          <div className="flex justify-between items-start mb-4">
                            <h3 className="text-xl font-medium">Secure Data Encryption</h3>
                            <Link
                          ...
                          <div className="flex flex-wrap gap-2">
                            <span className="text-xs bg-gray-800 text-gray-300 px-2 py-1 rounded-full">Streanlit</span>
                            <span className="text-xs bg-gray-800 text-gray-300 px-2 py-1 rounded-full">UV</span>
                            <span className="text-xs bg-gray-800 text-gray-300 px-2 py-1 rounded-full">hashlib</span>
                            <span className="text-xs bg-gray-800 text-gray-300 px-2 py-1 rounded-full">cryptography</span>
                          </div>
                        </div>
                      </div>
