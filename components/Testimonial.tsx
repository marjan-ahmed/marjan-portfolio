    ...
    <section className="py-16 border-t border-gray-800" id="testimonials">
      <div className="container max-w-4xl mx-auto px-4">
        ...
        <div className="relative">
          {/* Light background box positioned backward and offset to the left */}
          ...
          <div className="relative bg-gray-100 dark:bg-zinc-900 shadow-zinc-600 shadow-sm border-none rounded-xl p-6 sm:p-8 z-10">
            ...
            <p className="text-sm sm:text-md text-gray-900 dark:text-gray-300">
            ...
            <div className="mt-6">
              <p className="text-gray-900 dark:text-white font-semibold text-sm">Zain Ali Arain</p>
              <p className="text-gray-600 dark:text-gray-400 text-xs">NASA Space App Challenge Hackathon Team Leader</p>
            </div>
          </div>
        </div>
      </div>
